...
export interface DealWashout extends BaseResponseError {
    ...
    Accessory_ProfitCheck1: 0 | 1;
    Accessory_ProfitCheck2: 0 | 1;
    AcquisitionFee: string;
    AcquisitionFeeCheck1: 0 | 1;
    AcquisitionFeeCheck2: 0 | 1;
    ...
    Commission2: string;
    Commission2Enabled: 0 | 1;
    CommissionBase: string;
    CommissionMgr: string;
    CommissionMgrEnabled: 0 | 1;
    CommissionMgrOverride: string;
    CommissionMgrOverrideCheck1: 0 | 1;
    CommissionMgrOverrideCheck2: 0 | 1;
    ...
    Gap_Cost: string;
    Gap_Profit: string;
    Gap_ProfitCheck1: 0 | 1;
    Gap_ProfitCheck2: 0 | 1;
    Interest_Markup: string;
    Interest_MarkupCheck1: 0 | 1;
    Interest_MarkupCheck2: 0 | 1;
    Loan_Cost: string;
    MiscCost: string;
    MiscCostCheck1: 0 | 1;
    MiscCostCheck2: 0 | 1;
    MiscCostDescription: string;
    MiscCostMinus: string;
    MiscCostMinusCheck1: 0 | 1;
    MiscCostMinusCheck2: 0 | 1;
    MiscProfit: string;
    MiscProfitDescription: string;
    MiscProfitCheck1: 0 | 1;
    MiscProfitCheck2: 0 | 1;
    NetFI_Profit: string;
    Overallowance: string;
    OverallowanceCheck1: 0 | 1;
    OverallowanceCheck2: 0 | 1;
    PercentWitheld: string;
    ProjTermInterest: string;
    PurchaseCost: string;
    Reserve: string;
    ReserveCalculated: string;
    ReserveCheck1: 0 | 1;
    ReserveCheck2: 0 | 1;
    ReserveRefund: string;
    ReserveRefundCheck1: 0 | 1;
    ReserveRefundCheck2: 0 | 1;
    Reserve_Type: 0 | 1;
    StockNo: string;
    ...
    VSI_Profit: string;
    VSI_Type: 0 | 1;
    VSI_ProfitCheck1: 0 | 1;
    VSI_ProfitCheck2: 0 | 1;
    VehicleCost: string;
    VehiclePack: string;
    VehiclePackCheck1: 0 | 1;
    VehiclePackCheck2: 0 | 1;
    VehicleProfit: string;
    VehicleProfitCheck1: 0 | 1;
    VehicleProfitCheck2: 0 | 1;
