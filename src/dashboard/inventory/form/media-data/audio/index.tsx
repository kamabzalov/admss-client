...
export const AudioMedia = observer((): ReactElement => {
    ...
    const chooseTemplate = createMediaChooseTemplate({
        totalCount,
        limitations,
        dragDropMoreText: "To upload more drag and drop audio files",
        tooltipContent: audioLimitationsTooltip,
    });
    ...
    return (
        <div className='media grid'>
            ...
            />
            <MediaUploadFields
                categoryValue={uploadFileAudios?.data?.contenttype || 0}
                onCategoryChange={handleCategorySelect}
                notesValue={uploadFileAudios?.data?.notes || ""}
            ...
            <MediaUploadedSectionHeader
                ...
                currentCount={audios.length}
                maxCount={limitations.maxMediaCount ?? 0}
                highlightCount={!!audios.length}
            />
            <div className='media-grid'>
                {isLoading && <Loader />}
